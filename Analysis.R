...
ols1 = lm(bmi~(snapnowhh==1)+age.C+(sex==2)+(raceblack==1)+(hispanic==1)+
         educ.C+pctpovguidehh.C+hhsize.C+as.factor(marital), data=j2)
...
ols2 = lm(bmi~(snapnowhh==1)+age.C+(sex==2)+(raceblack==1)+(hispanic==1)+
         educ.C+pctpovguidehh.C+hhsize.C+as.factor(marital)+
         primstoredist_s.C+(rural==1)+povrate_p.C, data=j2)
...
iv1 = ivreg(bmi~age.C+(sex==2)+(raceblack==1)+(hispanic==1)+
         ...
         pctpovguidehh.C+hhsize.C+as.factor(marital), data=j2)
...
#Variable lists for near-far match
...
#Fit model
ols1.m1 = lm(bmi~(snapnowhh==1)+age.C+(sex==2)+(raceblack==1)+(hispanic==1)+
         educ.C+pctpovguidehh.C+hhsize.C+as.factor(marital), data=d1.m1)
...
m1a = matchit(snapnowhh ~ age + sex + raceblack + hispanic + educ + as.factor(marital) +
           ...
           "foodsecureq2", "wiccategelig", "farmworkerhh", "bmi", "pctpovguidehh")],
           method="nearest")

d1.m1a = match.data(m1a)
ols1.m1a = lm(bmi~(snapnowhh==1)+ age + sex + raceblack + hispanic + educ + as.factor(marital) +
           hhsize + pctpovguidehh + nutritioneduc + anydieting + huntfish + gardenown + foodpantry +
           foodsufficient + foodsecureq2 + wiccategelig + farmworkerhh, data=d1.m1a)
           #0.97 (0.57, 1.37)
summary(ols1.m1a)
confint(ols1.m1a)
...
#Fit model
ols2.m2 = lm(bmi~(snapnowhh==1)+age.C+(sex==2)+(raceblack==1)+(hispanic==1)+
         educ.C+pctpovguidehh.C+hhsize.C+as.factor(marital)+
         primstoredist_s.C+(rural==1)+povrate_p.C, data=d2.m2)
...
m2a = matchit(snapnowhh ~ age + sex + raceblack + hispanic + educ + as.factor(marital) +
           ...
           "povrate_p", "primstoredist_d", "primstoretime_d", "primstoretype", "primstoresource",
           "pctpovguidehh")], method="nearest")

d2.m2a = match.data(m2a)
ols2.m2a = lm(bmi~(snapnowhh==1)+ age + sex + raceblack + hispanic + educ + as.factor(marital) +
           hhsize + pctpovguidehh + nutritioneduc + anydieting + huntfish + gardenown + foodpantry +
           altstoresource + primstoretravelmode + primstoresource + foodsufficient +
           foodsecureq2 + wiccategelig + farmworkerhh + primstoredist_s + rural +
           povrate_p + primstoredist_d + primstoretime_d + primstoretype + primstoresource,
...
pdf("K:/Research/Research_Stanford_Basu/FoodAPS/Figures/PSoverlap_2017-06-28.pdf",
 width=8,height=8)
par(mfrow=c(2,2))
